...
class WeChatTools:
    ...
    def create_extraction_widgets(self):
        ...
        # 标题
        title_label = ttk.Label(main_frame, text="一键提取微信推送封面图", font=("Arial", 16, "bold"))
        ...
        info_text.insert(tk.END, "• 图片会自动下载到程序所在文件夹\n")
        info_text.insert(tk.END, "• 有bug联系QQ: 3230987336\n")
        info_text.insert(tk.END, "• 更新日期: 2025/6/12")
